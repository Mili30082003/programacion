/*  g. Asigne a la variable c el valor de a utilizando el puntero p. Muestre las variables a y c.*/
...
// 10 - Leo el numero
scanf("%d", &n3);
// 11 - Guardo el numero en una variable c
int c = n3;
// 12 - Muestro el contenido de c con su direccion de memoria 
printf("Contenido de c: %d\n", c);
printf("Direccion de Memoria de c: %p\n", &c);

// Asigno a la variable c el valor de a con puntero
 c = *p;
 // Imrpimo los valores
 printf("Variable a: %d\n", a);
 printf("Variable c: %d\n", *p);
